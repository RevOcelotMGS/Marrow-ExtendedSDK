...
namespace SLZ.Rig
{
	...
	{
		private SteamControllerRig _steamControllerRig;
		...
		public Transform valveWristTransform;
		...
		private void CalculateWristOffset()
		{
		}

		private ControllerInfo GetWristInfo()
		{
			return null;
		}
